...
var JobsComponent = __webpack_require__(7);
var jobs = new JobsComponent(http, util, render, $, moment);
...
var jobs = function jobs(dataGroup) {
  var finalHtml = '<div>';
...
var grabById = function grabById(id) {
...
var JobsComponent = function () {
  function JobsComponent(http, util, render, $, moment) {
  ...
  _createClass(JobsComponent, [{
    ...
    value: function getJobs() {
      ...
      this.http.get('http://localhost:9001/', function (data) {
        ...
        // currentWeekTime = response.total_time
        var renderedHtml = _this.render.jobs(response.jobs);
    ...
    value: function listen() {
      ...
      this.$.on("click", "#clock-in-btn", function (event) {
        ...
        _this2.http.post(baseUrl + '/time/clockIn', params, function (data) {
          ...
          if (response.success) {
            _this2.$.setAttr(_this2.$.grabById('clock-out-btn'), 'timeId', response.timeId);
            _this2.$.grabById('clock-in-btn').style.display = 'none';
            _this2.$.grabById('clock-out-btn').style.display = 'inline-block';
          }
        });
      });
      ...
      this.$.on("click", "#clock-out-btn", function (event) {
        ...
        _this2.http.put(baseUrl + '/time/clockOut', params, function (data) {
          ...
          if (response.success) {
            _this2.$.grabById('clock-out-btn').style.display = 'none';
            _this2.$.grabById('clock-in-btn').style.display = 'inline-block';
          }
        });
      });
    }
